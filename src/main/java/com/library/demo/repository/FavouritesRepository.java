...
public interface FavouritesRepository extends JpaRepository<Favourites,Long > {
    ...
    @Modifying
    @Query("DELETE FROM Favourites f WHERE f.username = :username AND f.bookId = :bookId")
    void deleteByUsernameAndBookId(@Param("username") String username, @Param("bookId") Long bookId);
}
